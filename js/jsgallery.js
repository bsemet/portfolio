...
$.fn.jsgallery = function(optionsOrMethod) {
			...
			$('#jsgall_nextButton').on("click", function() {
	        	loadNextImage();
	    	});
	    	
	    	$('#jsgall_prevButton').on("click", function() {
	        	loadPrevImage();
	    	});
	    	
	    	$('#jsgall_close').on("click", function() {
	        	methods.hide(self);
	    	});
	    
	    	
	    	$('#jsgall_imageContainer').on("click", function(e){
		    	if(e.target.id == "jsgall_imageContainer" && config.bgClickClose) methods.hide(self);
	    	})
	    	
	    	
	    	$(config.imgSelector).on("click", function(){
